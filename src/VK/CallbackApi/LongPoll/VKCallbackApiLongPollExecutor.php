...
class VKCallbackApiLongPollExecutor
{
	...
	protected VKApiClient $api_client;
	protected string $access_token;
	protected int $group_id;
	protected VKCallbackApiHandler $handler;
	protected CurlHttpClient $http_client;
	protected ?array $server;
	protected ?int $last_ts;
	protected int $wait;
	
	public function __construct(VKApiClient $api_client, string $access_token, int $group_id, VKCallbackApiHandler $handler, int $wait = self::DEFAULT_WAIT)
	{
	 ...
	 */
	public function listen(?int $ts = null): ?int
	{
		if ($this->server === null)
		{
