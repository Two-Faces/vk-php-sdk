...
use VK\Enums\LikesFilter;
use VK\Enums\LikesFriendsOnly;
...
class Likes implements ActionInterface
{
	 ...
	 * - @var integer item_id: Object ID. If 'type' is set as 'sitepage', 'item_id' can include the 'page_id' parameter value used during initialization of the [vk.ru/dev/Like|Like widget].
	 * - @var string page_url: URL of the page where the [vk.ru/dev/Like|Like widget] is installed. Used instead of the 'item_id' parameter.
