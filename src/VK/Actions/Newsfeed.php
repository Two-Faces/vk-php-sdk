...
class Newsfeed implements ActionInterface
{
	 ...
	 * - @var array[NewsfeedFields] fields: Additional fields of [vk.ru/dev/fields|profiles] and [vk.ru/dev/fields_groups|communities] to return.
	 * - @var string section
	 * @return mixed
	 * @throws VKClientException
	 * @throws VKApiException
	 ...
	 * - @var array[NewsfeedFields] fields: list of extra fields to be returned. See available fields for [vk.ru/dev/fields|users] and [vk.ru/dev/fields_groups|communities].
	 * @return mixed
	 * @throws VKClientException
	 * @throws VKApiException
	 */
