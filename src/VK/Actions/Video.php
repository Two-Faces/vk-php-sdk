...
class Video extends Action
{
	...
	{
		return $this->request->post('video.addAlbum', $access_token, $params, $apiTokenType);
	}
	...
	{
		return $this->request->post('video.addToAlbum', $access_token, $params, $apiTokenType);
	}
	...
	{
		return $this->request->post('video.createComment', $access_token, $params, $apiTokenType);
	}
	...
	{
		return $this->request->post('video.delete', $access_token, $params, $apiTokenType);
	}
	...
	{
		return $this->request->post('video.deleteComment', $access_token, $params, $apiTokenType);
	}
	...
	{
		return $this->request->post('video.edit', $access_token, $params, $apiTokenType);
	}
	...
	{
		return $this->request->post('video.editAlbum', $access_token, $params, $apiTokenType);
	}
	...
	{
		return $this->request->post('video.editComment', $access_token, $params, $apiTokenType);
	}
	...
	{
		return $this->request->post('video.get', $access_token, $params, $apiTokenType);
	}
	...
	{
		return $this->request->post('video.getAlbumById', $access_token, $params, $apiTokenType);
	}
	...
	{
		return $this->request->post('video.getAlbums', $access_token, $params, $apiTokenType);
	}
	 ...
	 * @return mixed
	 */
	public function getAlbumsByVideo(string $access_token, array $params = [], int $apiTokenType = VKApiTokenTypes::USER)
	{
		return $this->request->post('video.getAlbumsByVideo', $access_token, $params, $apiTokenType);
	}
	...
	{
		return $this->request->post('video.getComments', $access_token, $params, $apiTokenType);
	}
	...
	{
		return $this->request->post('video.removeFromAlbum', $access_token, $params, $apiTokenType);
	}
	 ...
	 * @return mixed
	 */
	public function reorderVideos(string $access_token, array $params = [], int $apiTokenType = VKApiTokenTypes::USER)
	{
		return $this->request->post('video.reorderVideos', $access_token, $params, $apiTokenType);
	}
	...
	{
		return $this->request->post('video.report', $access_token, $params, $apiTokenType);
	}
	...
	{
		return $this->request->post('video.reportComment', $access_token, $params, $apiTokenType);
	}
	...
	{
		return $this->request->post('video.restore', $access_token, $params, $apiTokenType);
	}
	...
	{
		return $this->request->post('video.restoreComment', $access_token, $params, $apiTokenType);
	}
	...
	{
		return $this->request->post('video.save', $access_token, $params, $apiTokenType);
	}
	...
	{
		return $this->request->post('video.search', $access_token, $params, $apiTokenType);
	}
}
